...
TOOLSETS = {
    ...
    "hermes-api-server": {
        "description": "OpenAI-compatible API server — core agent tools accessible via HTTP (no interactive UI tools like clarify or send_message)",
        "tools": [
            # Web
            "web_search",
            "web_extract",
    ...
    "hermes-cli": {
        "description": "Full interactive CLI toolset - core default tools",
