...
class TestFirecrawlClientConfig:
    ...
    def test_tool_gateway_env_alone_is_not_enough(self):
        """Managed tool gateway is removed; direct Firecrawl config is required."""
...
class TestCheckWebApiKey:
    ...
    def test_tool_gateway_env_only_returns_false(self):
        with patch.dict(os.environ, {"TOOL_GATEWAY_DOMAIN": "nousresearch.com"}):
            from tools.web_tools import check_web_api_key
    ...
    def test_configured_firecrawl_backend_accepts_direct_url(self):
        with patch(
